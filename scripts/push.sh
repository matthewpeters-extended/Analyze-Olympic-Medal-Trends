...
#
# Usage:
#   ./scripts/push.sh 1 "scaffold and acquire the raw data"
#
# Produces a commit message of the form "phase 1: scaffold and acquire the raw data",
...
echo
echo "==> guard: confirming no raw data is being committed"
